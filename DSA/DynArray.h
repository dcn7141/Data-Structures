...
class DynArray {
	...
	Type* mArray;
	unsigned int mSize;       //How much data there is in the dynamic array.	
	unsigned int mCapacity;         //The actual capacity of the array
...
public:
	...
	DynArray& operator=(const DynArray& _da)
	{
		...
		if (this != &_da)
		{
			...
			//Deep copy any dynamic data members // need to make new array and copy over data
	...
	{
		//mArray
		// mSize            //How much data there is in the dynamic array.
		// mCapacity        //The actual capacity of the array

		//If your array is full, call Reserve to get more memory, and then add your 
		//data into the next unused element and increase the size.
		//If your array is not full, then just add the data into the next unused 
